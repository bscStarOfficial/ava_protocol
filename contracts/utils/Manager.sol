...
contract Manager is Initializable, PausableUpgradeable, UUPSUpgradeable, AccessControlEnumerableUpgradeable {
    ...
    function allowUpgrade(address newImplementation, address sender) public view {
        ...
        require(
            ...
            keccak256(abi.encodePacked(_IMPLEMENTATION_SLOT)),
            "!UUID"
        );
    }
    ...
    ////////////////////////////////////   setter   //////////////////////////////////////////
    function pause() onlyRole(PAUSE) external {
        _pause();
    }

    function unpause() onlyRole(PAUSE) external {
        _unpause();
    }
