...
contract ATH is ExcludedFromFeeList, BaseUSDT, FirstLaunch, ERC20 {
    bool public presale;
    ...
    ) Owned(msg.sender) ERC20("Athena", "ATH", 18, 1310000 ether) {
        ...
        lockTheSwap
    {
        ...
        unchecked {
            ...
            uint256 profitUsdt = (amount * tokenAmount) / amountIn;
            uint256 projectFee = profitUsdt / 5; // 20% to project
            uint256 nodeFee = profitUsdt - projectFee; // 80% to node dividends
